...
public class TicTacToe extends JPanel{
    ...
    static JLabel information=new JLabel("<html>Welcome<br/>X will play first.<br/> Click near the center of a slot to place X in.");
    ...
    static void winningText() {
        ...
        if(winner!=null) {
            if (winner.equalsIgnoreCase("draw")) {
                ...
                information.setText("<html>Congratulations!<br/> "+ winner+ " has won!");
            }
        }
    }
